...
public class ControladorEspectaculo implements IControladorEspectaculo {
	...
	public void ingresarEspectaculo(String nombrePlat, String artistaOrganizador, DtEspectaculo dte) throws PlataformaNoExisteException, UsuarioNoExisteException {		
	...
	public void altaEspectaculo() {
		Espectaculo newE = new Espectaculo (dtesp.getNombre(), dtesp.getDescripcion(), dtesp.getURL(), dtesp.getDuracion(), dtesp.getCantMax(), dtesp.getCantMin(), dtesp.getCosto(), dtesp.getFechaReg(), plat, artistaOrg);
		ManejadorEspectaculo mE = ManejadorEspectaculo.getInstancia();
	...
	public DtEspectaculoCompleto seleccionarEspectaculo(String nombreEsp) throws EspectaculoNoValidoException {
		ManejadorEspectaculo mE = ManejadorEspectaculo.getInstancia();
