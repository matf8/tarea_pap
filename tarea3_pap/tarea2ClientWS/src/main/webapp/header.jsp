		    ...
		    <% if (tipo == null) { %>
		      <%} else if (tipo.equals("espectador")) { %>
		        <% if (!imagenPerfil.isEmpty()) { %>
					     	<div><img src="data:image/jpg;base64,<%=imagenPerfil%>" width="48" height="48" id="circle" onclick="{document.mostrarDatosUser.submit();}"></div>					      
						<% } else { %>
							 <div><img src="imagenes/userPlaceholder3.png" id="circle" onclick="{document.mostrarDatosUser.submit();}"></div>
						<% } %>
		     <a class="navbar-brand" href="index.jsp">Bienvenido <%=nick%></a>
			  ...
			  <form class="d-flex" action="MostrarDatosUsuario" name="mostrarDatosUser" method="post"></form>
			    ...
			    <div class="collapse navbar-collapse" id="navbarScroll">
			      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
			        ...
			        <li class="nav-item">
			          <a class="nav-link" onclick="{document.cerrarSesion.submit();}">Cerrar sesión</a>
			        </li>
			      </ul>
			      <div class="dis-flex">
