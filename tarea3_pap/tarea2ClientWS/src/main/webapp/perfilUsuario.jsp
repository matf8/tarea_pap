...
<%  String usuario = (String) request.getAttribute("nick");
	if (usuario != null) { %>
 ...
 <% List<String> seguidores =  (List<String>)request.getAttribute("listaSeguidores"); 
	...
	List<publicadores.DtFuncion> registros = (List<publicadores.DtFuncion>)request.getAttribute("registro_funciones");    
		...
		<div class="container">
	  		<div class="row">	  			
	  			...
	  			<%if(detector.detectMobileQuick()){ %>  
					<div class="container bg-secondary bg-gradient text-black">
				<%}else{ %>
						  ...
						  <div class="tab-pane fade show active" id="datos" role="tabpanel" aria-labelledby="datosUsuario">
							...
							<div class="row">	
								<div class="form-floating form-floating mb-2 col-sm-6">Fecha de nacimiento
								  <input type="text" class="form-control" id="fnac" value="<%=fnac%>" disabled>
								...
								<div class="container">
									<form action="InfoFuncion" name="frm" method="post" class="col-5">
										...
										<table class="table table-striped table-hover table-sm table-dark">
											...
											<tbody>
										    <% if (registros != null) {
											      for (publicadores.DtFuncion s: registros) { %>
											         <tr><td>
