				...
				<div class="container mt-5 bg-secondary bg-gradient text-white">
					<form action="RegistroFuncion" id="RegistroFuncion" method="post" class="row g-3">
					  ...
					  <div class="col-md-4">
					    ...
					    <input type="text" class="form-control" id="validationDefault02" name="fecha" value="<%=fecha%>" readonly>
					  </div>
					  
					  <div class="col-md-2">
					    <label for="validationDefault02" class="form-label">Hora</label>
					    <input type="text" class="form-control" id="validationDefault02" name="hora" value="<%=hora%>" readonly>
					  </div>		
