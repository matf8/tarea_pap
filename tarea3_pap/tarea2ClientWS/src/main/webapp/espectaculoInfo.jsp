...
<body>
	...
	String fReg = (String) request.getAttribute("fReg");
			...
			<div class="row">
				...
				<%} %>
				 	...
				 	<div class="tab-content" id="nav-tabContent">
						...
						<%} %>
								<div class="card-column text-white bg-dark mb-3" style="max-width: 870px;">
								  <div class="row g-0">								  										  		
								  	 <% if (!imagen.isEmpty()) { %>									  	 									
								    ...
								    <div class="col-md-12">
								      <div class="card-body" style="color:white">
								        ...
								        <p class="card-text" style="color:white"><small>Fecha registro: <%=fReg%></small></p>
