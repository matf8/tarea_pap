...
public class DtEspectaculo {
	...
	public DtEspectaculo(final String nombre, final String descripcion, final String url, final int duracion, final int cMax, final int cMin, final float costo, final LocalDate f, final String org, final String plat) {
		super();
		this.nombre = nombre;
