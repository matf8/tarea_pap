...
public class ControladorFuncion implements IControladorFuncion {	
	...
	public ArrayList<String> listarEspectaculosPorArtista(String nickOrganizador) throws Exception {
		...
		if (ret.isEmpty())
			throw new Exception("No tienes espectaculos organizados, da de alta un espectaculo");
		return ret;		
	}	
	...
	public void altaFuncion() {		
		Funcion f = new Funcion(dtfun.getNombre(), dtfun.getFecha(), dtfun.getHoraIni(), dtfun.getFechaReg(), invitados, img);
	...
	public DtFuncion seleccionarFuncion(String nombre) throws FuncionNoValidaException, Exception {
		Funcion f = null;		
