...
public class main {
	...
	public main() throws Exception {				
		...
		ControladorUsuarioPublish cp = new ControladorUsuarioPublish();
		cp.publicar();	
		ControladorEspectaculoPublish cpe= new ControladorEspectaculoPublish();
		cpe.publicar();
		ControladorFuncionPublish cpf= new ControladorFuncionPublish();
		cpf.publicar();
		ControladorPaquetePublish cpq= new ControladorPaquetePublish();
		cpq.publicar();
		ControladorPlataformaPublish cpp= new ControladorPlataformaPublish();
		cpp.publicar();
		...
		//registro a funcion de espectaculos
		registroFrame = new RegistroFuncionEspectaculo(iconF);
		registroFrame.setBounds(0, 0, 525, 513);
	...
	private void initialize() {					
		...
		iAltaUsuario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				altaUsuarioFrame.limpiarFormulario();
		...
		iConsultaUsuario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				consultaUsuarioFrame.limpiarFormulario();
		...
		iModificarUsuario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				modificarUsuarioFrame.limpiarFormulario();
		...
		iIngresarEspectaculo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				altaEspectaculoFrame.limpiarFormulario();
		...
		iIngresarFuncion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				altaFuncionFrame.limpiarFormulario();
		...
		iConsultaEspectaculo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				consultaEspectaculoFrame.limpiarFormulario();
		...
		iConsultaFuncion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				consultaFuncionFrame.limpiarFormulario();
		...
		iRegistro.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				registroFrame.limpiarFormulario();
		...
		iAltaPlataforma.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				altaPlataformaFrame.limpiarFormulario();
		...
		iCrearPaquetes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				crearPaqueteFrame.limpiarFormulario();
		...
		iConsultaPaquetes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				consultaPaqueteFrame.limpiarFormulario();
		...
		mntmAgregarEspectculoA.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				agregarEspectaculosAPaqueteFrame.limpiarFormulario();
