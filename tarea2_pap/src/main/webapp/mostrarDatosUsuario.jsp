					...
					<div class="container mt-5 bg-secondary bg-gradient text-white">
						<form action="ModificarUsuario" enctype="multipart/form-data" method="post" class="row g-3">
						  ...
						  <div class="col-md-2">
						    ...
						    <input type="date" class="form-control" id="validationDefault02" name="fnac" value="<%=fnac%>"required>
						  </div>			 
						  ...
						  <div class="col-md-2">
							  ...
							  <label class="btn btn-secondary">Cambiar foto de perfil</label>
						  </div>
						...
						<%if(tipo.equals("artista")){ %>
							  ...
							  <div class="col-md-4">
							    ...
							    <textarea class="form-control" id="validationDefault02" name="desc" required><%=desc%></textarea>
							  </div>
						 <%} %>
